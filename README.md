...
- 平台装配蓝图入口：`docs/platform/README.md`
- 平台配置与契约：`platform/`
- 集成版本清单：`release/platform-version.yaml`
- 平台 runbooks：`runbooks/`
- 新集群初始化脚本骨架：`scripts/bootstrap/cluster-init.sh`
