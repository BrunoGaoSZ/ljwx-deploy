# ljwx-core-api capability contract (dev)

## Namespace baseline

- namespace: `ljwx-core-api-dev`
...
```bash
bash scripts/ops/sync-registry-pull-secrets.sh --target-namespace ljwx-core-api-dev --registry-profile ghcr-and-harbor
kubectl create secret generic runtime-app -n ljwx-core-api-dev --from-literal=EXAMPLE_KEY='replace-me'
```
